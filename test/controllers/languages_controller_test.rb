...
class LanguagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create language" do
    assert_difference('Language.count') do
      post languages_url, params: { language: { name: @language.name, person_id: @language.person_id, proficiency: @language.proficiency } }
    end
  ...
  test "should update language" do
    patch language_url(@language), params: { language: { name: @language.name, person_id: @language.person_id, proficiency: @language.proficiency } }
